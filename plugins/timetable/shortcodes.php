...
function tt_event_hours($atts, $content)
{
	...
	{
		$output .= '<style type="text/css">' . (strtoupper($available_slots_color)!="34495E" ? ' .tt_event_hours .available_slots_wrapper span.available_slots { color:#' . $available_slots_color . ' !important;}' : '') . '</style>';
	}
