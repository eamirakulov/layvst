...
class FUE_Reports {
    ...
    public static function settings_main() {
        ...
        if ($tab == 'reports') {
            ...
            echo FUE_Reports::bounces_html( $_GET['eid'] );
    ...
    public static function queue() {
        ...
        <h2 class="nav-tab-wrapper woo-nav-tab-wrapper">
            <a href="admin.php?page=followup-emails&amp;tab=history" class="nav-tab"><?php _e('Emails History', 'follow_up_emails'); ?></a>
            <a href="admin.php?page=followup-emails-reports&amp;tab=dbg_queue" class="nav-tab nav-tab-active"><?php _e('Queue', 'follow_up_emails'); ?></a>
        </h2>
                    ...
                    <tr>
                        ...
                        foreach ($heading as $key):
                            ...
                            if ( $key == 'meta' && !empty($value) ) {
                                $value = '<a class="button" href="#" onclick="javascript: jQuery(\'#meta_'. $item['id'] .'\').slideToggle(); return false;">Show</a>';
                            }
                            ?>
