...
class Follow_Up_Emails {
    ...
    public static function is_sensei_installed() {
        ...
        $slug = 'woothemes-sensei/woothemes-sensei.php';
    ...
    public static function get_email_types() {
        ...
        $signup_props = apply_filters( 'fue_signup_email_properties', array(
            ...
            'short_description'     => __('Create emails to send when a user creates an account in your store, or signs up for a list.', 'follow_up_emails'),
            'long_description'      => __('Create emails to send when a user creates an account in your store, or signs up for a list.', 'follow_up_emails')
        ) );
        $signup = new FUE_Email_Type( 'signup', $signup_props );

        $manual_props = apply_filters( 'fue_manual_email_properties', array(
            'label'                 => __('Manual Emails', 'follow_up_emails'),
            'singular_label'        => __('Manual Email', 'follow_up_emails'),
            'list_template'         => FUE_TEMPLATES_DIR .'/email-list/manual-list.php',
            'triggers'              => array(),
            'supports'              => array(),
            'durations'             => array(),
            'short_description'     => __('Create manual emails to have templates, and create newsletters, for ad-hoc emails to customers and prospects.', 'follow_up_emails'),
            'long_description'      => __('Create manual emails to have templates, and create newsletters, for ad-hoc emails to customers and prospects.', 'follow_up_emails')
        ) );
