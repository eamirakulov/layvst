<?php
if ( ! function_exists( 'succulents_qodef_init_google_fonts_array' ) ) {
    function succulents_qodef_init_google_fonts_array() {
        ...
        $succulents_qodef_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'succulents_qodef_init_google_fonts_array');
}