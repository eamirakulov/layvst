<?php
$gallery_classes = '';
$number_of_columns = succulents_qodef_get_meta_field_intersect('portfolio_single_gallery_columns_number');
if(!empty($number_of_columns)) {
	$gallery_classes .= ' qodef-ps-'.$number_of_columns.'-columns';
}
$space_between_items = succulents_qodef_get_meta_field_intersect('portfolio_single_gallery_space_between_items');
if(!empty($space_between_items)) {
	$gallery_classes .= ' qodef-'.$space_between_items.'-space';
}
?>
<div class="qodef-ps-image-holder qodef-ps-gallery-images qodef-disable-bottom-space <?php echo esc_attr($gallery_classes); ?>">
