...
if ( ! function_exists( 'succulents_qodef_portfolio_options_map' ) ) {
	function succulents_qodef_portfolio_options_map() {
		...
		$panel_archive = succulents_qodef_add_admin_panel(
			array(
		...
		$panel = succulents_qodef_add_admin_panel(
			array(
		...
		$portfolio_gallery_container = succulents_qodef_add_admin_container(
			array(
				'parent'          => $panel,
		...
		$portfolio_masonry_container = succulents_qodef_add_admin_container(
			array(
				'parent'          => $panel,
		...
		$container_navigate_category = succulents_qodef_add_admin_container(
			array(
	...
	add_action( 'succulents_qodef_options_map', 'succulents_qodef_portfolio_options_map', 14 );
}