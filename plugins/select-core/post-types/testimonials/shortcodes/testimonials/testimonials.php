...
class Testimonials implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Show Icon', 'select-core' ),
						...
						array(
                            ...
                            'heading'     => esc_html__( 'Box Color', 'select-core' ),
                            'group'       => esc_html__( 'Layout Options', 'select-core' )
                        ),
						array(
							'type'        => 'dropdown',
	...
	public function render( $atts, $content = null ) {
		...
		$html = '<div class="qodef-testimonials-holder ' . $holder_classes . ' clearfix">';
			$html .= '<div class="qodef-testimonials qodef-owl-slider" ' . succulents_qodef_get_inline_attrs( $data_attr ) . '>';
			...
			if ( $query_results->have_posts() ):
				while ( $query_results->have_posts() ) : $query_results->the_post();
					...
					$html .= qodef_core_get_cpt_shortcode_module_template_part( 'testimonials', 'testimonials', 'testimonials-' . $params['type'], '', $params );
