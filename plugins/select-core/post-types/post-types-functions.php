...
if ( ! function_exists( 'qodef_core_include_custom_post_types_meta_boxes' ) ) {
	...
	add_action( 'succulents_qodef_before_meta_boxes_map', 'qodef_core_include_custom_post_types_meta_boxes' );
}
...
if ( ! function_exists( 'qodef_core_include_custom_post_types_global_options' ) ) {
	...
	add_action( 'succulents_qodef_before_options_map', 'qodef_core_include_custom_post_types_global_options', 1 );
}