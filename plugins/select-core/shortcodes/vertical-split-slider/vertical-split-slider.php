<?php
namespace QodeCore\CPT\Shortcodes\VerticalSplitSlider;
...
class VerticalSplitSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'      => esc_html__( 'Select Vertical Split Slider', 'select-core' ),
					'base'      => $this->base,
					...
					'params'    => array(
						array(
							...
							'heading'    => esc_html__( 'Enable Scrolling Animation', 'select-core' ),
