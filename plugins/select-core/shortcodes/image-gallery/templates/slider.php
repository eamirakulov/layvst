...
<div class="qodef-image-gallery <?php echo esc_attr($holder_classes); ?>">
	<div class="qodef-ig-slider qodef-owl-slider" <?php echo succulents_qodef_get_inline_attrs($slider_data); ?>>
			...
			<div class="qodef-ig-image">
				...
				<?php } ?>
					<?php if(is_array($image_size) && count($image_size)) :
						echo succulents_qodef_generate_thumbnail($image['image_id'], null, $image_size[0], $image_size[1]);
					else:
