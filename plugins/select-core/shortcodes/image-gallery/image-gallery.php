				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Auto Width', 'select-core' ),
							'value'       => array_flip( succulents_qodef_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider', 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'select-core' )
                        ...
                        array(
							...
							'heading'     => esc_html__( 'Enable Slider Center Item', 'select-core' ),
							'value'       => array_flip( succulents_qodef_get_yes_no_select_array( false ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'carousel' ) ),
							'group'       => esc_html__( 'Slider Settings', 'select-core' )
                        ...
                        array(
                            ...
                            'heading'     => esc_html__( 'Slider Pagination Skin', 'select-core' ),
                            'value'       => array(
