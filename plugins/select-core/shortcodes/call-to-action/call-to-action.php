<?php
namespace QodeCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface {
				...
				array(
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Set Content In Grid', 'select-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Content Elements Proportion', 'select-core' ),
							'value'      => array(
								esc_html__( '80/20', 'select-core' ) => '80',
						...
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px)', 'select-core' ),
							'dependency' => array( 'element' => 'layout', 'value' => array( 'simple' ) ),
							'group'      => esc_html__( 'Button Style', 'select-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_type',
							'heading'     => esc_html__( 'Button Type', 'select-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Link Target', 'select-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'select-core' ),
							'group'      => esc_html__( 'Button Style', 'select-core' )
						),
						array(
							'type'       => 'colorpicker',
							'param_name' => 'button_hover_color',
							'heading'    => esc_html__( 'Button Hover Color', 'select-core' ),
							'group'      => esc_html__( 'Button Style', 'select-core' )
						),
						array(
							'type'       => 'colorpicker',
						...
						array(
							...
							'value'      => esc_html__( 'I am test text for Call to Action shortcode content', 'select-core' )
						)
					)
				)
			);
	...
	public function render( $atts, $content = null ) {
		...
		$html = qodef_core_get_shortcode_module_template_part( 'templates/call-to-action', 'call-to-action', '', $params );
	...
	private function getButtonHolderStyles( $params ) {
		...
		if ( ! empty( $params['button_top_margin'] ) && $params['layout'] === 'simple' ) {
			$styles[] = 'margin-top: ' . succulents_qodef_filter_px( $params['button_top_margin'] ) . 'px';
		}
