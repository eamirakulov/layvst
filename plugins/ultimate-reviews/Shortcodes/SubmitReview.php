...
function Insert_Review_Form($atts) {
	...
	if ($user_update == $success_message and $redirect_page != '') {header('location:'. $redirect_page); exit();}
...
function EWD_URP_Add_Author_Field($Logged_In_User, $Required) {
	...
	if ($Logged_In_User['Author_Name'] == "") {
		...
		$ReturnString .= "<input type='text' name='Post_Author' id='Post_Author' value='" . $_POST['Post_Author'] . "' " . $Required_Text . "/>";
...
function EWD_URP_Add_Review_Title_Field($Required) {
	...
	$ReturnString .= "<input type='text' name='Post_Title' id='Post_Title' value='" . $_POST['Post_Title'] . "' " . $Required_Text . "/>";
...
function EWD_URP_Add_Review_Video_Field($Required) {
	...
	$ReturnString .= "<input type='URL' name='Review_Video' id='Review_Video' value='" . $_POST['Review_Video'] . "' " . $Required_Text . "/>";
...
function EWD_URP_Add_Review_Item_Field($Review_Category_Item) {
	...
	elseif ($Review_Score_Input == "Stars") {
		...
		$ReturnString .= "</div>";
		$ReturnString .= "<input type='text' id='ewd-urp-" . $Review_Category_Item['CategoryName'] . "' class='ewd-urp-hidden " . $Required_Text . "' name='" . $Review_Category_Item['CategoryName'] . "' value='" . $_POST['Overall_Score'] . "' />";
	}
	else {
...
function EWD_URP_Add_Review_Body_Field() {
	...
	$ReturnString .= "</label>";
	$ReturnString .= "<textarea name='Post_Body' class='ewd-urp-review-textarea' data-textareacount='" . $Textarea_Counter ."' required>" . $_POST['Post_Body'] . "</textarea>";
