					...
					<tr>
						...
						<td>
							<fieldset><legend class="screen-reader-text"><span>UPCP Integration</span></legend>
								<div class="ewd-urp-admin-hide-radios">
									<label title='Yes'><input type='radio' name='urp_integration' value='Yes' <?php if($UPCP_Integration == "Yes") {echo "checked='checked'";} ?> /> <span>Yes</span></label><br />
									<label title='No'><input type='radio' name='urp_integration' value='No' <?php if($UPCP_Integration  == "No") {echo "checked='checked'";} ?> /> <span>No</span></label><br />
								</div>
								<label class="ewd-urp-admin-switch">
									<input type="checkbox" class="ewd-urp-admin-option-toggle" data-inputname="urp_integration" <?php if($UPCP_Integration == "Yes") {echo "checked='checked'";} ?>>
									<span class="ewd-urp-admin-switch-slider round"></span>
								</label>		
