...
<div class="qodef-full-width">
	...
	<div class="qodef-full-width-inner">
        <?php do_action( 'succulents_qodef_after_container_inner_open' ); ?>
		<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
			<div class="qodef-grid-row">
				<div <?php echo succulents_qodef_get_content_sidebar_class(); ?>>
					<?php
						the_content();
						do_action( 'succulents_qodef_page_after_content' );
					?>
				</div>
		...
		<?php endwhile; endif; ?>
        <?php do_action( 'succulents_qodef_before_container_inner_close' ); ?>
	</div>
