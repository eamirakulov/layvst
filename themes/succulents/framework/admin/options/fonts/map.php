...
if ( ! function_exists( 'succulents_qodef_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function succulents_qodef_fonts_options_map() {
		
		succulents_qodef_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'succulents' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = succulents_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'succulents' )
			)
		);
		
		//H1
		$group_heading_h1 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = succulents_qodef_add_admin_row(
			array(
		...
		succulents_qodef_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'succulents' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h1_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H2
		$group_heading_h2 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h2_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h2_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h3_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h3_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h4_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h4_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h5_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h5_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'succulents' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'succulents' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h6_2 = succulents_qodef_add_admin_row(
			array(
		...
		$row_heading_h6_3 = succulents_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = succulents_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'succulents' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = succulents_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'succulents' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = succulents_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = succulents_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'succulents' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = succulents_qodef_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = succulents_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'succulents' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = succulents_qodef_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = succulents_qodef_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = succulents_qodef_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = succulents_qodef_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'succulents' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'succulents' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Table Portrait View)', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for table devices - portrait view', 'succulents' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'succulents' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'succulents' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = succulents_qodef_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'succulents' ),
				'description' => esc_html__( 'Define styles for link text', 'succulents' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		succulents_qodef_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'succulents' ),
				'parent'        => $row_link_1
			)
		);
		...
		succulents_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'succulents' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = succulents_qodef_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		succulents_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'succulents' ),
				'options'       => succulents_qodef_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		succulents_qodef_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'succulents' ),
				'options'       => succulents_qodef_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'succulents_qodef_options_map', 'succulents_qodef_fonts_options_map', 3 );
}