<?php
if($show_header_top) {
	do_action('succulents_qodef_before_header_top');
	?>
	...
	<div class="qodef-top-bar">
		<?php do_action( 'succulents_qodef_after_header_top_html_open' ); ?>
		...
		<?php do_action( 'succulents_qodef_before_header_top_html_close' ); ?>
	</div>
	
	<?php do_action('succulents_qodef_after_header_top');
}