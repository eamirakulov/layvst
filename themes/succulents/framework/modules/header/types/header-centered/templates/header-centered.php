...
<header class="qodef-page-header">
    ...
    <div class="qodef-logo-area">
	    <?php do_action( 'succulents_qodef_after_header_logo_area_html_open' ); ?>
    ...
    <div class="qodef-menu-area">
        ...
        <?php endif; ?>
            ...
            <div class="qodef-vertical-align-containers">
                <div class="qodef-position-center"><!--
                 --><div class="qodef-position-center-inner">
                        <?php succulents_qodef_get_main_menu(); ?>
                    </div>
                </div>
            </div>
	...
	<?php if($show_sticky) {
		succulents_qodef_get_sticky_header('centered', 'header/types/header-centered');
	} ?>
