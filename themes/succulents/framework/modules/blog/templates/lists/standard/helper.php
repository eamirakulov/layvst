...
if ( ! function_exists( 'succulents_qodef_get_blog_holder_classes' ) ) {
	/**
	 * Function that generates blog holder classes for blog page
	 */
	function succulents_qodef_get_blog_holder_classes( $classes ) {
	...
	add_filter( 'succulents_qodef_blog_holder_classes', 'succulents_qodef_get_blog_holder_classes' );
}
