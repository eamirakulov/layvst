...
class SucculentsQodefSimpleLineIcons implements iSucculentsQodefIconCollection {
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'succulents'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'succulents'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'succulents'),
            'icon-social-facebook'    => esc_html__('Facebook', 'succulents'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'succulents'),
            'icon-social-github'      => esc_html__('Github', 'succulents'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'succulents'),
            'icon-social-instagram'   => esc_html__('Instagram', 'succulents'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'succulents'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'succulents'),
            'icon-social-reddit'      => esc_html__('Reddit', 'succulents'),
            'icon-social-skype'       => esc_html__('Skype', 'succulents'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'succulents'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'succulents'),
            'icon-social-spotify'     => esc_html__('Spotify', 'succulents'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'succulents'),
            'icon-social-twitter'     => esc_html__('Twitter', 'succulents'),
            'icon-social-youtube'     => esc_html__('Youtube', 'succulents')
        );
    }
