 ...
 */
if ( ! function_exists( 'succulents_qodef_add_meta_box' ) ) {
	/**
	 * Adds new meta box
	 *
	 * @param $attributes
	 ...
	 */
	function succulents_qodef_add_meta_box( $attributes ) {
		$scope           = array();
		$title           = '';
		$name            = '';
...
if ( ! function_exists( 'succulents_qodef_add_meta_box_field' ) ) {
	/**
	 ...
	 * @return bool|SucculentsQodefField
	 */
	function succulents_qodef_add_meta_box_field( $attributes ) {
		$type            = '';
		$name            = '';
		$default_value   = '';
		$label           = '';
